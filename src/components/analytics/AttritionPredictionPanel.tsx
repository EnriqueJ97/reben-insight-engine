    ...
    const simulatedPrediction = {
      ...
      individual: [
        ...
        },
        {
          ...
          survivalProbability: 0.28,
          timeToAttrition: 4,
          recommendedActions: [
            'Mejorar balance vida-trabajo',
        ...
        {
          employeeName: 'Javier López',
          riskScore: 0.35,
          riskLevel: 'medium' as const,
          survivalProbability: 0.65,
          timeToAttrition: 12,
          recommendedActions: [
            'Mantener engagement actual',
            'Feedback regular'
          ]
        },
        {
          ...
          recommendedActions: [
            ...
            'Considerar para liderazgo'
          ]
        }
      ]
    };

    const highRiskEmployees = simulatedPrediction.individual.filter(emp => 
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-orange-600">
                    {(simulatedPrediction.organizationalRisk * 100).toFixed(0)}%
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">
                    {formatCurrency(simulatedPrediction.costImpact)}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">
                    {(simulatedPrediction.confidenceLevel * 100).toFixed(0)}%
                  </p>
                </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {simulatedPrediction.individual.map((employee, index) => (
