...
INSERT INTO public.shift_templates (
  ...
  (gen_random_uuid(), 'Turno Mañana', '08:00:00', '16:00:00', true),
  (gen_random_uuid(), 'Turno Tarde', '14:00:00', '22:00:00', true),
  (gen_random_uuid(), 'Turno Noche', '22:00:00', '06:00:00', true),
  (gen_random_uuid(), 'Horario Flexible', '09:00:00', '17:00:00', true);

-- Insertar algunos turnos asignados de ejemplo para el empleado
WITH shift_templates_data AS (
  SELECT id, name FROM public.shift_templates LIMIT 2
)
